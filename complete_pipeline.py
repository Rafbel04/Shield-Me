...
def full_pipeline(motherboard_image_path, output_scad_name=None,
    ...
    # ========================================================================
    print("\nSTEP 2: Detecting ports and generating mask...")
    print("-" * 70)
...
if __name__ == "__main__":
    ...
    full_pipeline(
        motherboard_image_path="motherboard_io.png",
        output_scad_name="my_shield.scad",
