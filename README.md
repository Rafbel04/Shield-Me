...
The primary output is a standalone `.scad` file that can be opened directly in [OpenSCAD](https://openscad.org/) without any external dependencies. The file structure is:
